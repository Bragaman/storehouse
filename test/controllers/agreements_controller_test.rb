...
class AgreementsControllerTest < ActionController::TestCase
  ...
  test "should create agreement" do
    assert_difference('Agreement.count') do
      post :create, agreement: { client_id: @agreement.client_id, expiration_date: @agreement.expiration_date, position: @agreement.position, receipt_date: @agreement.receipt_date, stack_id: @agreement.stack_id }
    end
  ...
  test "should update agreement" do
    patch :update, id: @agreement, agreement: { client_id: @agreement.client_id, expiration_date: @agreement.expiration_date, position: @agreement.position, receipt_date: @agreement.receipt_date, stack_id: @agreement.stack_id }
    assert_redirected_to agreement_path(assigns(:agreement))
  end
